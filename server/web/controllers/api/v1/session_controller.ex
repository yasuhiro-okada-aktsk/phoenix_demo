defmodule PhoenixDemoApp.Api.V1.SessionController do
  use PhoenixDemoApp.Web, :controller

  require Logger

  alias PhoenixDemoApp.UserAuth
  alias PhoenixDemoApp.UserQuery

  plug Guardian.Plug.EnsureAuthenticated,
    %{ on_failure: { PhoenixDemoApp.Api.V1.SessionController, :unauthenticated_api } } when not action in [:create]
  ...
  def create(conn, params = %{}) do
    ...
    if user do
      ...
      if changeset.valid? do
        ...
        conn
        |> put_status(:unauthorized)
        |> render(PhoenixDemoApp.ChangesetView, "error.json", changeset: nil)
    end
  end
